var OseCrypto = (() => {
  ...
  function signSchnorr(msgHashHex, privHex) {
    const sig = schnorr.sign(hexToBytes(msgHashHex), hexToBytes(privHex));
    return bytesToHex(sig);
  }
  function verifySchnorr(sigHex, msgHashHex, pubHex) {
    return schnorr.verify(hexToBytes(sigHex), hexToBytes(msgHashHex), hexToBytes(pubHex));
  }
