...
assert(isNewer('2.0.60', '2.0.59'), '2.0.60 > 2.0.59');
assert(!isNewer('2.0.59', '2.0.60'), '2.0.59 ≯ 2.0.60');
assert(isNewer('v2.0.60', '2.0.59'), 'strip v');
assert(!isNewer('2.0.59', '2.0.59'), 'égal → pas newer');
assert(isNewer('2.1.0', '2.0.99'), 'mineur gagne');
assert(versionCodeFromName('2.0.60') === 20060, 'versionCode 2.0.60 → 20060');
assert(versionCodeFromName('2.0.59') === 20059, 'versionCode 2.0.59 → 20059');
assert(versionCodeFromName('2.0.60') > versionCodeFromName('2.0.59'), 'codes monotones');
assert(versionCodeFromName('2.0.60') > 185, 'code marketing > ancien git-count (~185)');
...
assert(/android:versionCode="20060"/.test(man), 'manifest versionCode=20060');
