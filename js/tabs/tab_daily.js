/**
 * tab_daily.js - HTML de l'onglet Données horaires + analyse Enedis 30min
 *
 * v1.8.0 : - Auto-affichage si weatherData + hourlyEnedisData déjà disponibles
 *           - Affichage des 12 mois (dropdown + navigation)
 *           - Graphe de superposition des 12 mois (PV vs Conso)
 */
    ...
    <div class="tab-form-col">
      ...
      <div id="hourly-results">
        <div class="result-placeholder">
          ...
          <p>Cliquez sur <strong>Analyser les 12 mois</strong><br>
